        ...
        <div className="text-center mb-8 sm:mb-12 animate-fade-in">
          <div className="flex flex-col items-center justify-center gap-4 sm:gap-6 mb-4 sm:mb-6">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <h2 className="text-3xl sm:text-5xl md:text-7xl font-black bg-gradient-to-r from-primary via-secondary to-red-700 bg-clip-text text-transparent drop-shadow-lg" style={{ fontFamily: 'Merriweather, serif' }}>
